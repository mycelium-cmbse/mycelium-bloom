// ------------------------------------------------------------------------------------------------
// <copyright file="BloomReactiveInjectableComponentBase.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Bloom.Components.UI.Common
{
    ...
    /// <summary>
    /// Provides common Bloom parameters for reactive components whose ViewModel is supplied through dependency injection.
    /// </summary>
    /// <typeparam name="TViewModel">The observable ViewModel type.</typeparam>
    public abstract class BloomReactiveInjectableComponentBase<TViewModel> : ReactiveInjectableComponentBase<TViewModel>, IBloomComponentBase
