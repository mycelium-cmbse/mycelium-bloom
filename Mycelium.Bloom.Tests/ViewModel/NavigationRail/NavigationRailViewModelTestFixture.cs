...
namespace Mycelium.Bloom.Tests.ViewModel.NavigationRail
{
    ...
    public sealed class NavigationRailViewModelTestFixture
    {
        ...
        private static IReadOnlyList<NavigationRailItem> SelectItemsByLifecycleState(NavigationRailContext context)
        {
        ...
        private static IReadOnlyList<NavigationRailItem> SelectItemsByCombinedContext(
        ...
        private static IReadOnlyList<NavigationRailItem> SelectItemsWithEmptyReviewState(
            NavigationRailContext context)
        {
            return context.LifecycleState switch
            {
        ...
        private static void RecordInconsistentState(
            INavigationRailViewModel viewModel,
            ICollection<string> inconsistentSnapshots)
        {
